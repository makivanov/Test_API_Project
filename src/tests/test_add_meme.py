...
@allure.feature("Тесты для добавления мема")

@allure.step("Тест создания мема с корректными данными")
@allure.title("Тест создания мема с корректными данными")
...
@allure.title("Тест создания мема с некорректными данными")
...
@allure.title("Тест создания мема без авторизации")
...
@allure.title("Тест создания мема со случайным токеном")
@pytest.mark.parametrize("test_data", one_meme_test_data)
